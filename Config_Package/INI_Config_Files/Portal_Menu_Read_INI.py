...
class Read_Portal_Menu_Components:
    def __init__(self):
        ...
        try:
            portal_menu_ini_file_path = f'{Path(__file__).parent.parent.parent}\\Test_Data\\Data_From_INI\\Portal_Menu.ini'
    ...
    def get_usernameField(self):
        try:
            ...
            print("Enter username successfully : ", username)
            return username
        except Exception as ex:
            print(ex)
    ...
    def get_passwordField(self):
        try:
            ...
            # Base_Class.logger.info("URL read successfully : ", url)
            print("Enter password successfully : ", password)
            return password
        except Exception as ex:
            print(ex)
    ...
    def get_loginButton(self):
        try:
            ...
            # Base_Class.logger.info("URL read successfully : ", url)
            print("Click on login button successfully : ", login_btn)
            return login_btn
        except Exception as ex:
            print(ex)
    ...
    def get_username(self):
        try:
            ...
            # Base_Class.logger.info("URL read successfully : ", url)
            print("Get username successfully : ", username)
            return username
        except Exception as ex:
            print(ex)
    ...
    def get_password(self):
        try:
            ...
            # Base_Class.logger.info("URL read successfully : ", url)
            print("Get username successfully : ", password)
            return password
        except Exception as ex:
            print(ex)
    ...
    def logo_by_xpath(self):
        try:
            ...
            print("portal menu facefirst logo : ", logo_xpath)
            return logo_xpath
        except Exception as ex:
            print(ex)
    ...
    def portal_menu_event_btn_by_xpath(self):
        try:
            ...
            print("portal menu event btn xpath: ", event_btn_by_xpath)
    ...
    def portal_menu_event_validation_by_xpath(self):
        try:
            ...
            print("portal menu event validation xpath: ", event_validation_by_xpath)
    ...
    def portal_menu_tags_btn_by_xpath(self):
        try:
            ...
            print("portal menu tags btn xpath: ", tags_btn_by_xpath)
    ...
    def portal_menu_tags_validation_by_xpath(self):
        try:
            ...
            print("portal menu event validation xpath: ", tags_validation_by_xpath)
    ...
    def portal_menu_identify_enroll_btn_by_xpath(self):
        try:
            ...
            print("portal menu identify and enroll btn xpath: ", identify_enroll_btn_by_xpath)
    ...
    def portal_menu_indentify_enroll_validation_by_xpath(self):
        try:
            indentify_enroll_validation_by_xpath = self.config.get("Portal_Menu_Validation_LOCATORS", "identify_and_enroll_validation_by_xpath")
            print("portal menu event validation xpath: ", indentify_enroll_validation_by_xpath)
    ...
    def portal_menu_detect_faces_btn_by_xpath(self):
        try:
            ...
            print("portal menu detect faces btn xpath: ", detect_faces_btn_by_xpath)
    ...
    def portal_menu_detect_faces_validation_by_xpath(self):
        try:
            detect_faces_validation_by_xpath = self.config.get("Portal_Menu_Validation_LOCATORS", "detect_faces_validation_by_xpath")
            print("portal menu detect faces validation xpath: ", detect_faces_validation_by_xpath)
    ...
    def portal_menu_enrollments_btn_by_xpath(self):
        try:
            ...
            print("portal menu enrollments btn xpath: ", enrollments_btn_by_xpath)
    ...
    def portal_menu_enrollments_validation_by_xpath(self):
        try:
            enrollments_validation_by_xpath = self.config.get("Portal_Menu_Validation_LOCATORS", "enrollments_validation_by_xpath")
            print("portal menu enrollments validation xpath: ", enrollments_validation_by_xpath)
    ...
    def portal_menu_enrollments_groups_btn_by_xpath(self):
        try:
            enrollments_groups_btn_by_xpath = self.config.get("PORTAL_MENU_BUTTON_LOCATORS", "enrollment_groups_btn_by_xpath")
            print("portal menu enrollments groups btn xpath: ", enrollments_groups_btn_by_xpath)
    ...
    def portal_menu_enrollments_groups_validation_by_xpath(self):
        try:
            enrollments_groups_validation_by_xpath = self.config.get("Portal_Menu_Validation_LOCATORS", "enrollments_groups_validation_by_xpath")
            print("portal menu enrollments groups validation xpath: ", enrollments_groups_validation_by_xpath)
    ...
    def portal_menu_notification_groups_btn_by_xpath(self):
        try:
            notification_groups_btn_by_xpath = self.config.get("PORTAL_MENU_BUTTON_LOCATORS", "notification_Groups_btn_by_xpath")
            print("portal menu notification groups btn xpath: ", notification_groups_btn_by_xpath)
    ...
    def portal_menu_notification_groups_validation_by_xpath(self):
        try:
            notification_groups_validation_by_xpath = self.config.get("Portal_Menu_Validation_LOCATORS", "notification_groups_validation_by_xpath")
            print("portal menu notification groups validation xpath: ", notification_groups_validation_by_xpath)
    ...
    def portal_menu_visitors_btn_by_xpath(self):
        try:
            ...
            print("portal menu visitors btn xpath: ", visitors_btn_by_xpath)
    ...
    def portal_menu_visitors_validation_by_xpath(self):
        try:
            visitors_validation_by_xpath = self.config.get("Portal_Menu_Validation_LOCATORS", "visitors_validation_by_xpath")
            print("portal menu visitors validation xpath: ", visitors_validation_by_xpath)
    ...
    def portal_menu_visitors_search_btn_by_xpath(self):
        try:
            visitors_search_btn_by_xpath = self.config.get("PORTAL_MENU_BUTTON_LOCATORS", "visitors_search_btn_by_xpath")
            print("portal menu visitors search btn xpath: ", visitors_search_btn_by_xpath)
    ...
    def portal_menu_visitors_search_validation_by_xpath(self):
        try:
            visitors_search_validation_by_xpath = self.config.get("Portal_Menu_Validation_LOCATORS", "visitors_search_validation_by_xpath")
            print("portal menu visitors search validation xpath: ", visitors_search_validation_by_xpath)
    ...
    def portal_menu_visitors_search_job_btn_by_xpath(self):
        try:
            visitors_search_job_btn_by_xpath = self.config.get("PORTAL_MENU_BUTTON_LOCATORS", "visitors_search_job_btn_by_xpath")
            print("portal menu visitors search btn xpath: ", visitors_search_job_btn_by_xpath)
    ...
    def portal_menu_visitors_search_job_validation_by_xpath(self):
        try:
            visitors_search_job_validation_by_xpath = self.config.get("Portal_Menu_Validation_LOCATORS", "visitors_search_job_validation_by_xpath")
            print("portal menu visitors search job validation xpath: ", visitors_search_job_validation_by_xpath)
    ...
    def portal_menu_notes_btn_by_xpath(self):
        try:
            ...
            print("portal menu notes btn xpath: ", notes_btn_by_xpath)
    ...
    def portal_menu_notes_validation_by_xpath(self):
        try:
            ...
            print("portal menu notes validation xpath: ", notes_validation_by_xpath)
    ...
    def portal_menu_locations_btn_by_xpath(self):
        try:
            ...
            print("portal menu locations btn xpath: ", locations_btn_by_xpath)
    ...
    def portal_menu_locations_validation_by_xpath(self):
        try:
            locations_validation_by_xpath = self.config.get("Portal_Menu_Validation_LOCATORS", "locations_validation_by_xpath")
            print("portal menu locations validation xpath: ", locations_validation_by_xpath)
    ...
    def portal_menu_users_btn_by_xpath(self):
        try:
            ...
            print("portal menu users btn xpath: ", users_btn_by_xpath)
    ...
    def portal_menu_users_validation_by_xpath(self):
        try:
            ...
            print("portal menu users validation xpath: ", users_validation_by_xpath)
    ...
    def portal_menu_users_roles_btn_by_xpath(self):
        try:
            ...
            print("portal menu users roles btn xpath: ", users_roles_btn_by_xpath)
    ...
    def portal_menu_users_roles_validation_by_xpath(self):
        try:
            users_roles_validation_by_xpath = self.config.get("Portal_Menu_Validation_LOCATORS", "user_role_validation_by_xpath")
            print("portal menu users roles validation xpath: ", users_roles_validation_by_xpath)
    ...
    def portal_menu_zones_btn_by_xpath(self):
        try:
            ...
            print("portal menu zones btn xpath: ", zones_btn_by_xpath)
    ...
    def portal_menu_zones_validation_by_xpath(self):
        try:
            ...
            print("portal menu zones validation xpath: ", zones_validation_by_xpath)
    ...
    def portal_menu_account_btn_by_xpath(self):
        try:
            ...
            print("portal menu account btn xpath: ", account_btn_by_xpath)
    ...
    def portal_menu_account_validation_by_xpath(self):
        try:
            account_validation_by_xpath = self.config.get("Portal_Menu_Validation_LOCATORS", "account_validation_by_xpath")
            print("portal menu account validation xpath: ", account_validation_by_xpath)
    ...
    def portal_menu_reporting_btn_by_xpath(self):
        try:
            ...
            print("portal menu reporting btn xpath: ", reporting_btn_by_xpath)
    ...
    def portal_menu_reporting_validation_by_xpath(self):
        try:
            reporting_validation_by_xpath = self.config.get("Portal_Menu_Validation_LOCATORS", "reporting_validation_by_xpath")
            print("portal menu reporting validation xpath: ", reporting_validation_by_xpath)
    ...
    def portal_menu_notifier_btn_by_xpath(self):
        try:
            ...
            print("portal menu notifier btn xpath: ", notifier_btn_by_xpath)
    ...
    def portal_menu_notifier_validation_by_xpath(self):
        try:
            notifier_validation_by_xpath = self.config.get("Portal_Menu_Validation_LOCATORS", "notifier_validation_by_xpath")
            print("portal menu notifier validation xpath: ", notifier_validation_by_xpath)
    ...
    def portal_menu_dashboard_btn_by_xpath(self):
        try:
            ...
            print("portal menu dashboard btn xpath: ", dashboard_btn_by_xpath)
    ...
    def portal_menu_dashboard_validation_by_xpath(self):
        try:
            dashboard_validation_by_xpath = self.config.get("Portal_Menu_Validation_LOCATORS", "dashboard_validation_by_xpath")
            print("portal menu dashboard validation xpath: ", dashboard_validation_by_xpath)
    ...
    def copyright_btn_by_xpath(self):
        try:
            ...
            print("copyright btn xpath: ", copyright_btn_by_xpath)
    ...
    def copyright_validation_by_xpath(self):
        try:
            copyright_validation_by_xpath = self.config.get("Portal_Menu_Validation_LOCATORS", "copyright_validation_by_xpath")
            print("copyright validation xpath: ", copyright_validation_by_xpath)
    ...
    def profile_btn_by_xpath(self):
        try:
            ...
            print("profile btn xpath: ", profile_btn_by_xpath)
    ...
    def profile_validation_by_xpath(self):
        try:
            profile_validation_by_xpath = self.config.get("Portal_Menu_Validation_LOCATORS", "profile_validation_by_xpath")
            print("profile validation xpath: ", profile_validation_by_xpath)
    ...
    def logout_btn_by_xpath(self):
        try:
            ...
            print("logout btn xpath: ", logout_btn_by_xpath)
    ...
    def logout_validation_by_xpath(self):
        try:
            ...
            print("logout validation xpath: ", logout_validation_by_xpath)
    ...
    def user_profile_action_btn_by_xpath(self):
        try:
            user_profile_action_btn_by_xpath = self.config.get("PORTAL_MENU_BUTTON_LOCATORS", "user_profile_action_btn_by_xpath")
            print("user profile action btn by xpath: ", user_profile_action_btn_by_xpath)
    ...
    def user_profile_edit_btn_by_xpath(self):
        try:
            ...
            print("user profile edit btn by xpath: ", user_profile_edit_btn_by_xpath)
    ...
    def current_password_filed_by_xpath(self):
        try:
            current_password_filed_by_xpath = self.config.get("PORTAL_MENU_BUTTON_LOCATORS", "current_password_field_by_xpath")
            print("current password filed by xpath: ", current_password_filed_by_xpath)
    ...
    def new_password_filed_by_xpath(self):
        try:
            ...
            print("new password filed by xpath: ", new_password_filed_by_xpath)
    ...
    def confirm_password_filed_by_xpath(self):
        try:
            confirm_password_filed_by_xpath = self.config.get("PORTAL_MENU_BUTTON_LOCATORS", "confirm_new_password_by_xpath")
            print("confirm_password_filed_by_xpath: ", confirm_password_filed_by_xpath)
    ...
    def save_new_password(self):
        try:
            ...
            print("save new password: ", save_new_password)
    ...
    def password_change_validation(self):
        try:
            password_change_validation = self.config.get("Portal_Menu_Validation_LOCATORS", "password_change_validation")
            print("password change validation: ", password_change_validation)
    ...
    def rest_password_first_name_input(self):
        try:
            rest_password_first_name_input = self.config.get("PORTAL_MENU_BUTTON_LOCATORS", "rest_password_first_name_input")
            print("rest_password_first_name_input: ", rest_password_first_name_input)
    ...
    def rest_password_last_name_input(self):
        try:
            rest_password_last_name_input = self.config.get("PORTAL_MENU_BUTTON_LOCATORS", "rest_password_last_name_input")
            print("rest_password_last_name_input: ", rest_password_last_name_input)
    ...
    def portal_menu_closed_all_btn_by_xpath(self):
        try:
            ...
            print("portal menu event btn xpath: ", closed_all_btn_by_xpath)
    ...
    def portal_menu_cloud_menu_btn_by_xpath(self):
        try:
            ...
            print("portal menu cloud menu btn xpath: ", cloud_menu_btn_by_xpath)
    ...
    def portal_menu_close_notifier_btn_by_xpath(self):
        try:
            ...
            print("portal menu event btn xpath: ", close_notifier_btn_by_xpath)
    ...
    def portal_menu_copyright_expected_text(self):
        try:
            ...
            print("portal menu copyright expected text: ", portal_menu_copyright_expected_text)
    ...
    def current_and_new_password_not_same_validation(self):
        try:
            current_and_new_password_not_same_validation = self.config.get("Portal_Menu_Validation_LOCATORS", "current_and_new_password_not_same")
            print("current and new password not same validation: ", current_and_new_password_not_same_validation)
    ...
    def user_panel_cancel_btn(self):
        try:
            ...
            print("user panel cancel btn: ", user_panel_cancel_btn)
    ...
    def user_panel_close_btn(self):
        try:
            ...
            print("user panel close btn: ", user_panel_close_btn)
    ...
    def get_upper_case_password(self):
        try:
            ...
            print("get upper case password", get_upper_case_password)
    ...
    def get_lower_case_password(self):
        try:
            ...
            print("get lower case password", get_lower_case_password)
    ...
    def get_special_character_password(self):
        try:
            ...
            print("get special character password", get_special_character_password)
    ...
    def get_less_than_eight_character_password(self):
        try:
            get_less_than_eight_character_password = self.config.get("PORTAL_LOGIN_PAGE_DATA", "less_than_eight_character")
            print("get less than eight character password", get_less_than_eight_character_password)
    ...
    def less_than_eight_character_validation_password(self):
        try:
            less_than_eight_character_validation_password = self.config.get("Portal_Menu_Validation_LOCATORS", "password_less_than_eight_validation")
            print("less than eight character validation password", less_than_eight_character_validation_password)
    ...
    def event_panel_validation_text(self):
        try:
            event_panel_validation_text = self.config.get("Portal_Menu_Validation_LOCATORS", "event_panel_validation_text")
            print("event_panel_validation_text", event_panel_validation_text)
    ...
    def tags_panel_validation_text(self):
        try:
            tags_panel_validation_text = self.config.get("Portal_Menu_Validation_LOCATORS", "tags_panel_validation_text")
            print("tags_panel_validation_text", tags_panel_validation_text)
    ...
    def identify_and_enroll_panel_validation_text(self):
        try:
            identify_and_enroll_panel_validation_text = self.config.get("Portal_Menu_Validation_LOCATORS", "identify_and_enroll_panel_validation_text")
            print("identify_and_enroll_panel_validation_text", identify_and_enroll_panel_validation_text)
    ...
    def detect_faces_validation_text(self):
        try:
            detect_faces_validation_text = self.config.get("Portal_Menu_Validation_LOCATORS", "detect_faces_validation_text")
            print("detect_faces_validation_text", detect_faces_validation_text)
    ...
    def enrollments_panel_validation_text(self):
        try:
            enrollments_panel_validation_text = self.config.get("Portal_Menu_Validation_LOCATORS", "enrollments_panel_validation_text")
            print("enrollments_panel_validation_text", enrollments_panel_validation_text)
    ...
    def enrollments_groups_panel_validation_text(self):
        try:
            enrollments_groups_panel_validation_text = self.config.get("Portal_Menu_Validation_LOCATORS", "enrollments_groups_panel_validation_text")
            print("enrollments_groups_panel_validation_text", enrollments_groups_panel_validation_text)
    ...
    def visitors_panel_validation_text(self):
        try:
            visitors_panel_validation_text = self.config.get("Portal_Menu_Validation_LOCATORS", "visitors_panel_validation_text")
            print("visitors_panel_validation_text", visitors_panel_validation_text)
    ...
    def visitor_search_panel_validation_text(self):
        try:
            visitor_search_panel_validation_text = self.config.get("Portal_Menu_Validation_LOCATORS", "visitor_search_panel_validation_text")
            print("visitor_search_panel_validation_text", visitor_search_panel_validation_text)
    ...
    def close_all_panel_list(self):
        try:
            ...
            print("close_all_panel_list", close_all_panel_list)
    ...
    def notification_groups_panel_validation_text(self):
        try:
            notification_groups_panel_validation_text = self.config.get("Portal_Menu_Validation_LOCATORS", "notification_groups_panel_validation_text")
            print("notification_groups_panel_validation_text", notification_groups_panel_validation_text)
    ...
    def visitor_search_jobs_panel_text(self):
        try:
            visitor_search_jobs_panel_text = self.config.get("Portal_Menu_Validation_LOCATORS", "visitor_search_jobs_panel_text")
            print("visitor_search_jobs_panel_text", visitor_search_jobs_panel_text)
    ...
    def notes_panel_validation_text(self):
        try:
            notes_panel_validation_text = self.config.get("Portal_Menu_Validation_LOCATORS", "notes_panel_validation_text")
            print("notes_panel_validation_text", notes_panel_validation_text)
    ...
    def locations_panel_validation_text(self):
        try:
            locations_panel_validation_text = self.config.get("Portal_Menu_Validation_LOCATORS", "locations_panel_validation_text")
            print("locations_panel_validation_text", locations_panel_validation_text)
    ...
    def user_panel_validation_text(self):
        try:
            user_panel_validation_text = self.config.get("Portal_Menu_Validation_LOCATORS", "user_panel_validation_text")
            print("user_panel_validation_text", user_panel_validation_text)
    ...
    def user_roles_validation_text(self):
        try:
            user_roles_validation_text = self.config.get("Portal_Menu_Validation_LOCATORS", "user_roles_validation_text")
            print("user_roles_validation_text", user_roles_validation_text)
    ...
    def zones_panel_validation_text(self):
        try:
            zones_panel_validation_text = self.config.get("Portal_Menu_Validation_LOCATORS", "zones_panel_validation_text")
            print("zones_panel_validation_text", zones_panel_validation_text)
    ...
    def account_panel_validation_text(self):
        try:
            account_panel_validation_text = self.config.get("Portal_Menu_Validation_LOCATORS", "account_panel_validation_text")
            print("account_panel_validation_text", account_panel_validation_text)
    ...
    def reporting_validation_text(self):
        try:
            ...
            print("reporting_validation_text", reporting_validation_text)
    ...
    def dashboard_panel_validation_text(self):
        try:
            dashboard_panel_validation_text = self.config.get("Portal_Menu_Validation_LOCATORS", "dashboard_panel_validation_text")
            print("dashboard_panel_validation_text", dashboard_panel_validation_text)
    ...
    def notifier_panel_validation_text(self):
        try:
            notifier_panel_validation_text = self.config.get("Portal_Menu_Validation_LOCATORS", "notifier_panel_validation_text")
            print("notifier_panel_validation_text", notifier_panel_validation_text)
    ...
    def validation_user_panel_text(self):
        try:
            validation_user_panel_text = self.config.get("Portal_Menu_Validation_LOCATORS", "validation_user_panel_text")
            print("validation_user_panel_text", validation_user_panel_text)
    ...
    def copyright_version_text_validation(self):
        try:
            copyright_version_text_validation = self.config.get("Portal_Menu_Validation_LOCATORS", "copyright_version_text_validation")
            print("copyright_version_text_validation", copyright_version_text_validation)
    ...
    def copyright_year_text_validation(self):
        try:
            copyright_year_text_validation = self.config.get("Portal_Menu_Validation_LOCATORS", "copyright_year_text_validation")
            print("copyright_year_text_validation", copyright_year_text_validation)
