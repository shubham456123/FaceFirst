...
class Read_Tags_Components:
    ...
    def get_commit_changes_expected_msg_by_xpath(self):
        try:
            get_commit_changes_expected_msg_by_xpath = self.config.get("ASSERTIONS", "commit_changes_validation_expected_msg")
    ...
    def tag_name_already_exists_validation_by_xpath(self):
        try:
            tag_name_already_exists_validation_by_xpath = self.config.get("ASSERTIONS", "Tag_name already_exists_validation_xpath")
    ...
    def close_panel_and_discard_changes_btn_by_xpath(self):
        try:
            close_panel_and_discard_changes_btn_by_xpath = self.config.get("LOCATORS", "close_panel_and_discard_changes")
    ...
    def tags_action_btn_by_xpath(self):
        try:
            tags_action_btn_by_xpath = self.config.get("LOCATORS", "tages_delete_action_btn_by_xpath")
    ...
    def expected_duplicate_tag_validation_msg(self):
        try:
            expected_duplicate_tag_validation_msg = self.config.get("ASSERTIONS", "expected_duplicate_tag_validation_msg")
    ...
    def close_panel_and_discard_changes_input(self):
        try:
            close_panel_and_discard_changes_input = self.config.get("ASSERTIONS", "close_panel_and_discard_changes_input")
    ...
    def expected_discard_changes_warning_by_xpath(self):
        try:
            expected_discard_changes_warning_by_xpath = self.config.get("LOCATORS", "expected_discard_changes_warning_by_xpath")
    ...
    def expected_uncommitted_changes_msg_by_xpath(self):
        try:
            expected_uncommitted_changes_msg_by_xpath = self.config.get("LOCATORS", "expected_uncommitted_changes_msg_by_xpath")
