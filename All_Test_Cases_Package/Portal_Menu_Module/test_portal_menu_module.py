...
class Test_Portal_Menu_Test_Cases(Base_Class):
    ...
    def test_TC_PM_26(self):
        ...
        if Portal_Menu_pom().current_and_new_password_not_same_validation():
            ...
            self.d.save_screenshot(f"{self.screenshots_path}\\test_verify_current_and_new_password_not_same_validation.png")
            assert False
    ...
    def test_TC_PM_23(self):
        ...
        if Portal_Menu_pom().facefirst_logo_validation():
            assert True
        else:
