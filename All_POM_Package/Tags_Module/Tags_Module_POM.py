...
class Tags_Module_pom:
    ...
    def create_tags_for_serious_event(self):
        ...
        try:
            for r in range(3, rows+1):
                ...
                serious_event_checkbox = self.d.find_element(By.XPATH, Read_Tags_Components().get_serious_event_checkbox_by_xpath())
                ...
                if duplicate_tag.is_displayed():
                    ...
                    tag_create_success_expected_validation_msg = Read_Tags_Components().create_tag_success_msg_expected()
        ...
        try:
            ...
            for r in range(3, rows+1):
                ...
                duplicate_tag = self.d.find_element(By.XPATH,
                                                    Read_Tags_Components().tag_name_already_exists_validation_by_xpath())
                if duplicate_tag.is_displayed():
    ...
    def filter_serious_event_tags_varify_it(self):
        ...
        try:
            ...
            filter_btn.click()
            serious_event_filter = self.d.find_element(By.XPATH, Read_Tags_Components().serious_event_filter_btn_by_xpath())
        ...
        try:
            ...
            for r in range(2, rows + 1):
                ...
                serious_event_checkbox = self.d.find_element(By.XPATH,
                                                             Read_Tags_Components().get_serious_event_checkbox_by_xpath())
                serious_event_checkbox.click()
                save = self.d.find_element(By.XPATH, Read_Tags_Components().get_save_btn_by_xpath())
                save.click()
                try:
                    ...
                    print(actual_duplicate_tag_validation_msg)
                    expected_duplicate_tag_validation_msg = Read_Tags_Components().expected_duplicate_tag_validation_msg()
            ...
            if msg.__contains__('not clickable at point'):
                print("Exception crated: ", ex, " #returning false# ")
                self.d.save_screenshot(
                    f"{Path(__file__).parent.parent}\\Screenshots\\duplicate_tags_not_create_validation_failed_pg_03.png")
                return False
    ...
    def update_serious_event_tag_name(self):
        ...
        try:
            ...
            edit_btn_list = []
            for r in range(2, rows + 1):
                tags_name.insert(r - 2, XLUtils.readdata(test_data, 'serious_event_tags_data', r, 3))
            filter_btn = self.d.find_element(By.XPATH, Read_Tags_Components().filter_btn_by_xpath())
            filter_btn.click()
            ...
            edit_btn_list = self.d.find_elements(By.XPATH,
                                                 Read_Tags_Components().list_of_edit_tag_name_btn_by_xpath())
            print(edit_btn_list)

            for i in range(1, len(edit_btn_list)):

                try:
                    self.d.execute_script("arguments[0].click();", edit_btn_list[i])
                ...
                tag_name_field.send_keys(tags_name[i])
                save = self.d.find_element(By.XPATH, Read_Tags_Components().get_save_btn_by_xpath())
    ...
    def delete_all_tages(self):
        ...
        try:
            ...
            if msg.__contains__('not clickable at point'):
                print("Exception crated: ", ex, " #returning false# ")
                self.d.save_screenshot(
                    f"{Path(__file__).parent.parent}\\Screenshots\\delete_all_tages_failed_pg_03.png")
                return False
    ...
    def verify_deterred_tag_is_present_at_first(self):
        try:
            ...
            assert actual_deterred_tag == expected_deterred_tag
            Tags_Module_pom().close_all_panel_one_by_one()
            Portal_Menu_pom().click_on_logout_button()
            return True
    ...
    def close_panel_and_discard_changes_verify(self):
        try:
            ...
            close_panel.click()
            time.sleep(Base_Class.one_second)
            warning_msg = self.d.find_element(By.XPATH, Read_Tags_Components().expected_discard_changes_warning_by_xpath())
            ...
            uncommitted_changes_msg = self.d.find_element(By.XPATH,
                                              Read_Tags_Components().expected_uncommitted_changes_msg_by_xpath())
            ...
            if msg.__contains__('not clickable at point'):
                print("Exception crated: ", ex, " #returning false# ")
                self.d.save_screenshot(
                    f"{Path(__file__).parent.parent}\\Screenshots\\close_panel_and_discard_changes_verify_failed_pg_03.png")
                return False
