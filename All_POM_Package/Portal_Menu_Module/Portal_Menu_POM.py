...
class Portal_Menu_pom:
    ...
    def event_button_validation(self):
        try:
            ...
            time.sleep(Base_Class.one_second)
            event_validation = self.d.find_element(By.XPATH, Read_Portal_Menu_Components().portal_menu_event_validation_by_xpath())
            ...
            if msg.__contains__('not clickable at point'):
                print("Exception crated: ", ex, " #returning false# ")
                self.d.save_screenshot(
                    f"{Path(__file__).parent.parent}\\Screenshots\\menu_event_vaildation_faild_pg_03.png")
                return False
    ...
    def tags_button_validation(self):
        try:
            ...
            time.sleep(Base_Class.one_second)
            tags_validation = self.d.find_element(By.XPATH, Read_Portal_Menu_Components().portal_menu_tags_validation_by_xpath())
            ...
            if msg.__contains__('not clickable at point'):
                print("Exception crated: ", ex, " #returning false# ")
                self.d.save_screenshot(
                    f"{Path(__file__).parent.parent}\\Screenshots\\menu_tags_vaildation_faild_pg_03.png")
                return False

    def click_on_identify_enroll_button(self):
        try:
            time.sleep(Base_Class.one_second)
            identify_enroll_button = self.d.find_element(By.XPATH, Read_Portal_Menu_Components().portal_menu_identify_enroll_btn_by_xpath())
            ...
            if msg.__contains__('not clickable at point'):
                print("Exception crated: ", ex, " #returning false# ")
                self.d.save_screenshot(
                    f"{Path(__file__).parent.parent}\\Screenshots\\Button_not_clickable_portal_menu_identify_enroll_pg_03.png")
                return False
    ...
    def identify_enroll_button_validation(self):
        try:
            ...
            time.sleep(Base_Class.one_second)
            identify_enroll_validation = self.d.find_element(By.XPATH, Read_Portal_Menu_Components().portal_menu_indentify_enroll_validation_by_xpath())
            actual_identify_enroll_validation_text = identify_enroll_validation.text
            expected_identify_enroll_validation_text = Read_Portal_Menu_Components().identify_and_enroll_panel_validation_text()
            ...
            if msg.__contains__('not clickable at point'):
                print("Exception crated: ", ex, " #returning false# ")
                self.d.save_screenshot(
                    f"{Path(__file__).parent.parent}\\Screenshots\\identify_enroll_vaildation_faild_pg_03.png")
                return False
    ...
    def click_on_detect_faces_button(self):
        try:
            time.sleep(Base_Class.one_second)
            detect_faces_button = self.d.find_element(By.XPATH, Read_Portal_Menu_Components().portal_menu_detect_faces_btn_by_xpath())
    ...
    def detect_faces_button_validation(self):
        try:
            ...
            time.sleep(Base_Class.one_second)
            detect_faces_validation = self.d.find_element(By.XPATH, Read_Portal_Menu_Components().portal_menu_detect_faces_validation_by_xpath())
            ...
            if msg.__contains__('not clickable at point'):
                print("Exception crated: ", ex, " #returning false# ")
                self.d.save_screenshot(
                    f"{Path(__file__).parent.parent}\\Screenshots\\detect_faces_vaildation_faild_pg_03.png")
                return False


    def click_on_enrollmets_button(self):
        try:
            time.sleep(Base_Class.one_second)
            enrollments_button = self.d.find_element(By.XPATH, Read_Portal_Menu_Components().portal_menu_enrollments_btn_by_xpath())
            ...
            if msg.__contains__('not clickable at point'):
                print("Exception crated: ", ex, " #returning false# ")
                self.d.save_screenshot(
                    f"{Path(__file__).parent.parent}\\Screenshots\\Button_not_clickable_portal_menu_enrollments_pg_03.png")
                return False

    def enrollments_button_validation(self):
        try:
            Portal_Menu_pom().login_before()
            Portal_Menu_pom().click_on_enrollmets_button()
            time.sleep(Base_Class.one_second)
            enrollments_validation = self.d.find_element(By.XPATH, Read_Portal_Menu_Components().portal_menu_enrollments_validation_by_xpath())
    ...
    def click_on_enrollmets_groups_button(self):
        try:
            time.sleep(Base_Class.one_second)
            enrollments_groups_button = self.d.find_element(By.XPATH, Read_Portal_Menu_Components().portal_menu_enrollments_groups_btn_by_xpath())
            ...
            if msg.__contains__('not clickable at point'):
                print("Exception crated: ", ex, " #returning false# ")
                self.d.save_screenshot(
                    f"{Path(__file__).parent.parent}\\Screenshots\\Button_not_clickable_portal_menu_enrollments_groups_pg_03.png")
                return False

    def enrollments_groups_button_validation(self):
        try:
            Portal_Menu_pom().login_before()
            Portal_Menu_pom().click_on_enrollmets_groups_button()
            time.sleep(Base_Class.one_second)
            enrollments_groups_validation = self.d.find_element(By.XPATH, Read_Portal_Menu_Components().portal_menu_enrollments_groups_validation_by_xpath())
            actual_enrollments_groups_validation = enrollments_groups_validation.text
            expected_enrollments_groups_validation = Read_Portal_Menu_Components().enrollments_groups_panel_validation_text()
    ...
    def click_on_notification_groups_button(self):
        try:
            time.sleep(Base_Class.one_second)
            notification_groups_button = self.d.find_element(By.XPATH, Read_Portal_Menu_Components().portal_menu_notification_groups_btn_by_xpath())
            ...
            if msg.__contains__('not clickable at point'):
                print("Exception crated: ", ex, " #returning false# ")
                self.d.save_screenshot(
                    f"{Path(__file__).parent.parent}\\Screenshots\\Button_not_clickable_portal_menu_notification_groups_pg_03.png")
                return False
    ...
    def notification_groups_button_validation(self):
        try:
            ...
            time.sleep(Base_Class.one_second)
            notification_groups_validation = self.d.find_element(By.XPATH, Read_Portal_Menu_Components().portal_menu_notification_groups_validation_by_xpath())
            actual_notification_groups_validation = notification_groups_validation.text
            expected_notification_groups_validation = Read_Portal_Menu_Components().notification_groups_panel_validation_text()
    ...
    def click_on_visitors_button(self):
        try:
            time.sleep(Base_Class.one_second)
            visitors_button = self.d.find_element(By.XPATH, Read_Portal_Menu_Components().portal_menu_visitors_btn_by_xpath())
    ...
    def visitors_button_validation(self):
        try:
            ...
            time.sleep(Base_Class.one_second)
            visitors_validation = self.d.find_element(By.XPATH, Read_Portal_Menu_Components().portal_menu_visitors_validation_by_xpath())
    ...
    def click_on_visitors_search_button(self):
        try:
            time.sleep(Base_Class.one_second)
            visitors_search_button = self.d.find_element(By.XPATH, Read_Portal_Menu_Components().portal_menu_visitors_search_btn_by_xpath())
            ...
            if msg.__contains__('not clickable at point'):
                print("Exception crated: ", ex, " #returning false# ")
                self.d.save_screenshot(
                    f"{Path(__file__).parent.parent}\\Screenshots\\Button_not_clickable_portal_menu_visitors_search_pg_03.png")
                return False
    ...
    def visitors_search_button_validation(self):
        try:
            ...
            time.sleep(Base_Class.one_second)
            visitors_search_validation = self.d.find_element(By.XPATH, Read_Portal_Menu_Components().portal_menu_visitors_search_validation_by_xpath())
    ...
    def click_on_visitors_search_job_button(self):
        try:
            time.sleep(Base_Class.one_second)
            visitors_search_job_button = self.d.find_element(By.XPATH, Read_Portal_Menu_Components().portal_menu_visitors_search_job_btn_by_xpath())
            ...
            if msg.__contains__('not clickable at point'):
                print("Exception crated: ", ex, " #returning false# ")
                self.d.save_screenshot(
                    f"{Path(__file__).parent.parent}\\Screenshots\\Button_not_clickable_portal_menu_visitors_search_job_pg_03.png")
                return False
    ...
    def visitors_search_button_job_validation(self):
        try:
            ...
            time.sleep(Base_Class.one_second)
            visitors_search_job_validation = self.d.find_element(By.XPATH, Read_Portal_Menu_Components().portal_menu_visitors_search_job_validation_by_xpath())
    ...
    def notes_validation(self):
        try:
            ...
            time.sleep(Base_Class.one_second)
            notes_validation = self.d.find_element(By.XPATH, Read_Portal_Menu_Components().portal_menu_notes_validation_by_xpath())
    ...
    def click_on_locations_button(self):
        try:
            time.sleep(Base_Class.one_second)
            locations_button = self.d.find_element(By.XPATH, Read_Portal_Menu_Components().portal_menu_locations_btn_by_xpath())
    ...
    def locations_validation(self):
        try:
            ...
            time.sleep(Base_Class.one_second)
            locations_validation = self.d.find_element(By.XPATH, Read_Portal_Menu_Components().portal_menu_locations_validation_by_xpath())
    ...
    def users_validation(self):
        try:
            ...
            time.sleep(Base_Class.one_second)
            users_validation = self.d.find_element(By.XPATH, Read_Portal_Menu_Components().portal_menu_users_validation_by_xpath())
    ...
    def click_on_users_role_button(self):
        try:
            time.sleep(Base_Class.one_second)
            users_roles_button = self.d.find_element(By.XPATH, Read_Portal_Menu_Components().portal_menu_users_roles_btn_by_xpath())
            ...
            if msg.__contains__('not clickable at point'):
                print("Exception crated: ", ex, " #returning false# ")
                self.d.save_screenshot(
                    f"{Path(__file__).parent.parent}\\Screenshots\\Button_not_clickable_portal_menu_users_roles_pg_03.png")
                return False
    ...
    def users_roles_validation(self):
        try:
            ...
            time.sleep(Base_Class.one_second)
            users_roles_validation = self.d.find_element(By.XPATH, Read_Portal_Menu_Components().portal_menu_users_roles_validation_by_xpath())
    ...
    def zones_button_validation(self):
        try:
            ...
            time.sleep(Base_Class.one_second)
            zones_validation = self.d.find_element(By.XPATH, Read_Portal_Menu_Components().portal_menu_zones_validation_by_xpath())
    ...
    def click_on_account_button(self):
        try:
            time.sleep(Base_Class.one_second)
            account_button = self.d.find_element(By.XPATH, Read_Portal_Menu_Components().portal_menu_account_btn_by_xpath())
    ...
    def account_button_validation(self):
        try:
            ...
            time.sleep(Base_Class.one_second)
            account_validation = self.d.find_element(By.XPATH, Read_Portal_Menu_Components().portal_menu_account_validation_by_xpath())
    ...
    def click_on_reporting_button(self):
        try:
            time.sleep(Base_Class.one_second)
            reporting_button = self.d.find_element(By.XPATH, Read_Portal_Menu_Components().portal_menu_reporting_btn_by_xpath())
    ...
    def reporting_button_validation(self):
        try:
            ...
            time.sleep(Base_Class.one_second)
            reporting_validation = self.d.find_element(By.XPATH, Read_Portal_Menu_Components().portal_menu_reporting_validation_by_xpath())
    ...
    def click_on_notifier_button(self):
        try:
            time.sleep(Base_Class.one_second)
            notifier_button = self.d.find_element(By.XPATH, Read_Portal_Menu_Components().portal_menu_notifier_btn_by_xpath())
    ...
    def notifier_button_validation(self):
        try:
            ...
            time.sleep(Base_Class.one_second)
            notifier_validation = self.d.find_element(By.XPATH, Read_Portal_Menu_Components().portal_menu_notifier_validation_by_xpath())
    ...
    def click_on_dashboard_button(self):
        try:
            time.sleep(Base_Class.one_second)
            dashboard_button = self.d.find_element(By.XPATH, Read_Portal_Menu_Components().portal_menu_dashboard_btn_by_xpath())
    ...
    def dashboard_button_validation(self):
        try:
            ...
            dashboard_validation = self.d.find_element(By.XPATH, Read_Portal_Menu_Components().portal_menu_dashboard_validation_by_xpath())
    ...
    def copyright_button_validation(self):
        try:
            ...
            assert copyright_validation.text.__contains__(Read_Portal_Menu_Components().copyright_version_text_validation())
            assert copyright_validation.text.__contains__(Read_Portal_Menu_Components().copyright_year_text_validation())
            Portal_Menu_pom().close_all_panel_one_by_one()
            Portal_Menu_pom().click_on_logout_button()
            return True
        except Exception as ex:
    ...
    def profile_button_validation(self):
        try:
            ...
            time.sleep(Base_Class.one_second)
            profile_validation = self.d.find_element(By.XPATH, Read_Portal_Menu_Components().profile_validation_by_xpath())
    ...
    def facefirst_logo_validation(self):
        try:
            Portal_Menu_pom().login_before()
            time.sleep(Base_Class.one_second)
            try:
                self.d.execute_script("document.body.style.zoom='95%'")
            except Exception as ex:
                msg = str(ex)
    ...
    def logout_button_validation(self):
        try:
            ...
            Portal_Menu_pom().click_on_logout_button()
            time.sleep(Base_Class.one_second)
            logout_validation = self.d.find_element(By.XPATH, Read_Portal_Menu_Components().logout_validation_by_xpath())
            time.sleep(Base_Class.one_second)
    ...
    def current_and_new_password_not_same_validation(self):
        try:
            ...
            validation_msg = self.d.find_element(By.XPATH,
                                                   Read_Portal_Menu_Components().current_and_new_password_not_same_validation())
            print(validation_msg.is_displayed())
    ...
    def set_upper_case_password(self):
        try:
            ...
            password = [Read_Portal_Menu_Components().get_upper_case_password(), Read_Portal_Menu_Components().get_password(),
    ...
    def set_lower_case_password(self):
        try:
            ...
            password = [Read_Portal_Menu_Components().get_lower_case_password(), Read_Portal_Menu_Components().get_password(),
    ...
    def set_special_character_password(self):
        try:
            ...
            password = [Read_Portal_Menu_Components().get_special_character_password(), Read_Portal_Menu_Components().get_password(),
    ...
    def set_less_than_eight_character_password(self):
        try:
            ...
            save_btn = self.d.find_element(By.XPATH,
                                           Read_Portal_Menu_Components().save_new_password())
            save_btn.click()
            less_char_vaidation = self.d.find_element(By.XPATH,
                                                      Read_Portal_Menu_Components().less_than_eight_character_validation_password())
            less_char_vaidation.is_displayed()
            cancel_btn = self.d.find_element(By.XPATH,
                                             Read_Portal_Menu_Components().user_panel_cancel_btn())
            cancel_btn.click()
            closed_button = self.d.find_element(By.XPATH,
    ...
    def close_all_panel_button(self):
        try:
            Portal_Menu_pom().login_before()
            time.sleep(Base_Class.one_second)
            self.click_on_enrollmets_button()
